...
class MediaPipeline:
    ...
    def _process_request(self, request: Request, info, item: dict):
    ...
    def _modify_media_request(self, request: Request):
        if self.handle_httpstatus_list:
            request.meta['handle_httpstatus_list'] = self.handle_httpstatus_list
        else:
            request.meta['handle_httpstatus_all'] = True

    def _check_media_to_download(self, result, request: Request, info: SpiderInfo, item: dict):
    ...
    def _cache_result_and_execute_waiters(self, result, fp, info: SpiderInfo):
    ...
    def media_failed(self, failure, request: Request, info: SpiderInfo):
